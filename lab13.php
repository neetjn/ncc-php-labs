<?php
  ...
  session_start( /**/ );
    // # begin session to store or retrieve existing number

  $data = (object) $_SESSION;
    // # dump session data into local variable
        ...
        <div class="jumbotron">
          <?php if( isset( $input ) && !$error ): ?>
            ...
            <?php if( $data->random == $input->choice ): ?>
              ...
              <?php $data->random = rand( 1, 50 ); $data->turns = 0; $_SESSION = (array) $data; ?>
            <?php else: $data->turns++; $_SESSION = (array) $data; ?>
          ...
          <form name='flag' class="form-horizontal" method='post'>
            <fieldset>
              <legend>Lab 13 / Data Input</legend>
