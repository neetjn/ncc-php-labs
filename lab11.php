        ...
        <div class="jumbotron">
          <?php if( isset( $input ) && !$error ): ?>
            ...
            <?php if( $data->random == $input->choice ): ?>
              ...
              <?php $data->random = rand( 1, 50 ); $data->turns = 0; ?>
            <?php else: $data->turns++; ?>
          ...
          <form name='flag' class="form-horizontal" method='post'>
            <fieldset>
              <legend>Lab 11 / Data Input</legend>
              ...
              <div class="form-group hidden">
                <label for="random" class="col-lg-2 control-label">Random</label>
                <div class="col-lg-10">
                  <input type="text" id="random" name="random" class="form-control" value="<?php echo $data->random; ?>" readonly>
                </div>
              </div>
              <div class="form-group hidden">
                <label for="turns" class="col-lg-2 control-label">Turns</label>
                <div class="col-lg-10">
                  <input type="text" id="turns" name="turns" class="form-control" value="<?php echo $data->turns; ?>" readonly>
                </div>
              </div>
              <div class="form-group">
